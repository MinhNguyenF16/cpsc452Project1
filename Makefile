...
cipher:	cipher.o Playfair.o Caesar.o Railfence.o RowTransposition.o Vigenere.o
	g++ -std=c++11 cipher.o Playfair.o Caesar.o Railfence.o RowTransposition.o Vigenere.o -o cipher
